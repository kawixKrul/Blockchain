...
data class Block(val id: Int, val timestamp: Long, val previousHash: String, val miner: Int) {
    var data: List<Message> = listOf()
    private val magicNumber = Random.nextInt()
    val hash = applySha256("$id$timestamp$previousHash$magicNumber$miner")
